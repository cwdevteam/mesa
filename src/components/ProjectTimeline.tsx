...
import { TimelineEvent, TimelineFile, TimelineFileEvent, TimelineTextEvent, useTimeline } from "@/context/TimelineContext";
        ...
        <Textarea 
          ...
          onKeyDown={(e) => {
            if (e.key === 'Enter' && e.shiftKey === false) {
              console.log(e)
              e.preventDefault();
              dispatch({type: "add", event: { type: 'text', content: e.currentTarget.value }});
